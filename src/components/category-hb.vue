    ...
    <div class="container col-12">
        <div class="row justify-content-start">
            <div class="d-none d-md-block sidebar col-3 align-items-start">
                ...
                <b-dropdown-item-button class="btn-change7">Health & Beauty</b-dropdown-item-button>
                <b-dropdown-item-button class="btn-change7">Beautty product</b-dropdown-item-button>
                ...
                <b-dropdown-item-button class="btn-change7">Soap</b-dropdown-item-button>
                <b-dropdown-item-button class="btn-change7">Hair Beauty Equipment</b-dropdown-item-button>
            </div>
            <div class="col-9 row ">
